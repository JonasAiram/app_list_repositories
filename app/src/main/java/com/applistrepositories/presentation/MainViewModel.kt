package com.applistrepositories.presentation
...
import com.applistrepositories.domain.ListUserRepositoriesUseCase
...
class MainViewModel(
    ...
    fun clearRepoList() {
        _repos.postValue(State.Success(listUserRepositoriesUseCase.clearRepoList()))
    }
