package com.applistrepositories.data.di

import android.util.Log
import com.applistrepositories.data.repositories.RepoRepository
import com.applistrepositories.data.repositories.RepoRepositoryImplements
...
object DataModule {
    ...
    private fun networkModules(): Module {
        return module {
            ...
            single {
                createdService<GitHubService>(get(), get())
            }
        }
    }
    ...
    private fun repositoriesModule(): Module {
        return module {
            single<RepoRepository> { RepoRepositoryImplements(get()) }
        }
    }
