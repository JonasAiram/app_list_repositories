...
import com.applistrepositories.databinding.ItemRepositorBinding
...
class RepoListAdapter : ListAdapter<Repo, RepoListAdapter.ViewHolder>(DiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = ItemRepositorBinding.inflate(inflater, parent, false)
    ...
    inner class ViewHolder(
        private val binding: ItemRepositorBinding
    ) : RecyclerView.ViewHolder(binding.root) {

        fun bind(item: Repo) {
            binding.tvNameRepositorie.text = item.name
